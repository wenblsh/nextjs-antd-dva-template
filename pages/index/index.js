...
class Index extends Component {
  ...
  initModal = () =>{
    return ['测试1','测试2','测试3', '测试4'].map((e,i)=>{
  ...
  renderModalButton = () =>{
    return this.formModalArr.map((e,i)=>{
      return <Button key={i} onClick={()=>this.onTest1(i)}>{'打开测试modal' + i + '本页面不走生命周期'}</Button>
    })
  }
